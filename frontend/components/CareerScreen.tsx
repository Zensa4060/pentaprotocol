...
export default function CareerScreen({ themeId, onHoverAction }: Props) {
  ...
  return (
    <div style={{
      position: "fixed", inset: 0, zIndex: 2, background: themeId === "pixel" ? "url(/bg-pixel.png) center/cover no-repeat" : themeId === "space" ? "url(/bg-earth.png) center/cover no-repeat" : t.bg,
      overflowY: "scroll",
      overflowX: "hidden",
