...
const BANNERS: { id: string; label: string; gradient: string; unlockDesc: string; condition: (p: any) => boolean }[] = [
  ...
  { id: "crimson",    label: "Crimson Dawn",    gradient: "linear-gradient(135deg,#1a0000,#4a0000,#8b0000)",
    unlockDesc: "Reach Master rank", condition: p => (p.elo||0) >= 2000 },
  { id: "emerald",    label: "Emerald Depths",  gradient: "linear-gradient(135deg,#001a0d,#003d1a,#006b2e)",
    unlockDesc: "Reach Emerald rank", condition: p => (p.elo||0) >= 1500 },
  { id: "ocean",      label: "Deep Ocean",      gradient: "linear-gradient(135deg,#000d1a,#001f3f,#003366)",
    unlockDesc: "Win 25 matches", condition: p => (p.wins||0) >= 25 },
  { id: "void",       label: "The Void",        gradient: "linear-gradient(135deg,#000000,#0d0015,#1a0030)",
    unlockDesc: "Reach Legend rank", condition: p => (p.elo||0) >= 2500 },
  { id: "gold",       label: "Golden Era",      gradient: "linear-gradient(135deg,#1a1000,#3d2800,#6b4400)",
    unlockDesc: "Win 100 matches", condition: p => (p.wins||0) >= 100 },
  { id: "aurora",     label: "Aurora",          gradient: "linear-gradient(135deg,#001a1a,#003333,#004d40)",
    unlockDesc: "Play 50 total games", condition: p => ((p.wins||0)+(p.losses||0)+(p.draws||0)) >= 50 },
  { id: "nebula",     label: "Nebula",          gradient: "linear-gradient(135deg,#0d001a,#1a003d,#2d0066)",
    unlockDesc: "Reach level 10", condition: p => (p.level||0) >= 10 },
];
...
export const PROFILE_BORDERS: {
  ...
  { id: "silver",        label: "Silver Ring",      tier: "basic",
    css: "0 0 0 3px #9CA3AF, 0 0 0 5px #9CA3AF22",
    glowColor: "#9CA3AF",
    unlockDesc: "Reach 500 ELO",
    condition: p => (p.elo||0) >= 500,             animation: "none" },
  { id: "blue_pulse",    label: "Blue Pulse",       tier: "rare",
    css: "0 0 0 3px #60A5FA, 0 0 12px #60A5FA66",
    glowColor: "#60A5FA",
    unlockDesc: "Reach Advanced rank",
    condition: p => (p.elo||0) >= 500,             animation: "pulse" },
  { id: "emerald_veil",  label: "Emerald Veil",     tier: "rare",
    css: "0 0 0 3px #10B981, 0 0 16px #10B98166",
    glowColor: "#10B981",
    unlockDesc: "Reach Emerald rank",
    condition: p => (p.elo||0) >= 1500,            animation: "pulse" },
  { id: "crimson_flame", label: "Crimson Flame",    tier: "epic",
    css: "0 0 0 3px #FF3333, 0 0 0 6px #FF333344, 0 0 22px #FF333388",
    glowColor: "#FF3333",
    unlockDesc: "Reach Master rank",
    condition: p => (p.elo||0) >= 2000,            animation: "fire" },
  { id: "violet_arc",    label: "Violet Arc",       tier: "epic",
    css: "0 0 0 2px #7C3AED, 0 0 0 5px #A78BFA44, 0 0 18px #A78BFA66",
    glowColor: "#A78BFA",
    unlockDesc: "Win 100 ranked matches",
    condition: p => (p.wins||0) >= 100,            animation: "electric" },
  { id: "gold_sovereign",label: "Gold Sovereign",   tier: "legendary",
    css: "0 0 0 3px #F59E0B, 0 0 0 7px #F59E0B33, 0 0 28px #F59E0BAA",
    glowColor: "#F59E0B",
    unlockDesc: "Reach Legend rank",
    condition: p => (p.elo||0) >= 2500,            animation: "spin" },
  { id: "rainbow_halo",  label: "Rainbow Halo",     tier: "legendary",
    css: "0 0 0 3px transparent",
    glowColor: "#FF6B6B",
    unlockDesc: "Win 200 ranked matches",
    condition: p => (p.wins||0) >= 200,            animation: "rainbow" },
];
