...
export default function RulesScreen({ themeId, onHoverAction, onClickAction }: Props) {
  ...
  return (
    <div style={{ minHeight:"100vh", padding:"84px 24px 64px", background: themeId === "pixel" ? "url(/bg-pixel-dark.png) center/cover no-repeat" : "transparent", transition:"background 0.4s", display:"flex", flexDirection:"column", alignItems:"center", position: "relative", zIndex: 2 }}>
