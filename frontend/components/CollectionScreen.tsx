...
export default function CollectionScreen({ themeId, setThemeIdAction, onHoverAction, onClickAction }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 2, background: themeId === "pixel" ? "url(/bg-pixel.png) center/cover no-repeat" : themeId === "space" ? "url(/bg-earth.png) center/cover no-repeat" : t.bg, paddingTop: 84, overflowY: "auto", transition: "background 0.4s" }}>
