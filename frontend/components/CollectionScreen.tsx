...
export default function CollectionScreen({ themeId, setThemeIdAction, onHoverAction, onClickAction }: Props) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 2, background: themeId === "pixel" ? "url(/bg-pixel-hills.png) center/cover no-repeat" : themeId === "space" ? "transparent" : t.bg, paddingTop: 84, overflowY: "auto", transition: "background 0.4s" }}>
