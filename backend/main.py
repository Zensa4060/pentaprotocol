...
from app.routers import auth, game, profile, store, bot, analyze, bot7, room, otp, admin, friends, syros, argus
...
app.include_router(syros, prefix="/api/syros", tags=["syros"])
app.include_router(argus, prefix="/api/argus", tags=["argus"])
